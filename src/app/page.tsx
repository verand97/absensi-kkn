...
export default async function Home() {
  ...
  return (
    <div className="min-h-screen lg:h-screen w-full lg:w-screen overflow-y-auto lg:overflow-hidden bg-slate-50 dark:bg-[#0B0D14] text-slate-900 dark:text-white font-sans relative selection:bg-purple-500/30">
      ...
      <div className="container mx-auto px-4 md:px-6 h-full flex flex-col relative z-10 py-3 md:py-5">
        ...
        <div className="grid lg:grid-cols-12 gap-3 lg:gap-8 flex-1 min-h-0 items-center">
          ...
          <div className="lg:col-span-6 flex flex-col items-start relative z-20 w-full h-full justify-start lg:justify-center overflow-hidden py-1 lg:py-0">
            ...
            <div className="absolute top-2 right-[-8%] w-40 h-40 lg:hidden flex items-center justify-center opacity-[0.15] pointer-events-none overflow-hidden z-[-1]">
            ...
            {/* Tag Pill */}
            <div 
              className="relative inline-flex items-center gap-3 mb-2 md:mb-4 p-px bg-slate-200 dark:bg-slate-700/50"
            ...
            {/* Description */}
            <p className="text-slate-600 dark:text-slate-400 text-[11px] md:text-sm lg:text-base max-w-md mb-2.5 md:mb-5 leading-snug pr-2 md:pr-0">
            ...
            <div className="flex items-center gap-4 group cursor-pointer mb-2.5 lg:mb-0">
              <Link href="/dashboard" className="relative p-px bg-[#7F56FF] group-hover:bg-[#80FF56] transition-colors" style={{ clipPath: "polygon(12px 0, 100% 0, 100% calc(100% - 12px), calc(100% - 12px) 100%, 0 100%, 0 12px)" }}>
                ...
                >
                  ...
                  <div className="px-3 py-2 md:px-4 md:py-3.5 border-l border-slate-300 dark:border-white/10 flex items-center justify-center bg-slate-200/50 dark:bg-white/5">
            ...
            <div className="grid grid-cols-3 gap-1.5 w-full lg:hidden mt-2">
              ...
              {/* Stat 1 */}
              <div className="flex flex-col items-center justify-center p-1.5 bg-slate-100 dark:bg-[#101217] rounded-lg border border-slate-200 dark:border-slate-800 shadow-md">
                <Users className="w-3.5 h-3.5 text-purple-400 mb-0.5" />
                <span className="text-sm sm:text-base font-black text-[#80FF56] leading-none">{totalMembers}</span>
              ...
              <div className="flex flex-col items-center justify-center p-1.5 bg-slate-100 dark:bg-[#101217] rounded-lg border border-slate-200 dark:border-slate-800 shadow-md">
                ...
                <span className="text-sm sm:text-base font-black text-[#80FF56] leading-none">H-{currentDay}</span>
              ...
              {/* Stat 3 */}
              <div className="flex flex-col items-center justify-center p-1.5 bg-slate-100 dark:bg-[#101217] rounded-lg border border-slate-200 dark:border-slate-800 shadow-md">
                <Activity className="w-3.5 h-3.5 text-purple-400 mb-0.5" />
                <span className="text-sm sm:text-base font-black text-[#80FF56] leading-none">{progressPercent}%</span>
