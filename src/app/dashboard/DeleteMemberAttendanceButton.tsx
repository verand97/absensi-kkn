  ...
  return (
    <>
      <button
        ...
        className="text-slate-500 dark:text-mist-500 hover:text-rose-500 bg-slate-200 dark:bg-forest-900 hover:bg-rose-500/10 border border-slate-200 dark:border-forest-700 hover:border-rose-500/30 p-2 transition-colors disabled:opacity-50 inline-flex items-center justify-center cursor-pointer"
        style={{ clipPath: "polygon(4px 0, 100% 0, 100% calc(100% - 4px), calc(100% - 4px) 100%, 0 100%, 0 4px)" }}
      >
        {isDeleting
          ? <span className="w-3.5 h-3.5 border border-rose-500/50 border-t-rose-500 rounded-full animate-spin" />
          : <UserMinus size={14} />
        }
      </button>
          ...
          >
            <div className="p-6">
              ...
              <div className="flex justify-center mb-4">
                <div className="w-14 h-14 rounded-full bg-rose-500/10 border border-rose-500/30 flex items-center justify-center shadow-[0_0_20px_rgba(217,83,79,0.15)]">
              ...
              <p className="text-center text-sm font-bold text-rose-500 mb-4">
                {memberName}
              </p>
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="flex-1 py-2.5 text-xs font-bold uppercase tracking-widest bg-rose-500 hover:bg-rose-600 text-white transition-all shadow-[0_0_12px_rgba(217,83,79,0.3)] cursor-pointer"
                  style={{ clipPath: "polygon(6px 0, 100% 0, 100% calc(100% - 6px), calc(100% - 6px) 100%, 0 100%, 0 6px)" }}
                >
                  Ya, Hapus!
                </button>
