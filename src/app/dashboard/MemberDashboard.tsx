...
export default function MemberDashboard({ member, setting }: { member: MemberData, setting: SettingData }) {
  ...
  return (
    <div className="min-h-screen bg-[#0B0D14] text-white font-sans overflow-x-hidden relative selection:bg-[#7F56FF]/30 pb-24 md:pb-8">
      ...
      <div className="max-w-4xl mx-auto px-6 py-8 relative z-10">
        ...
        <header className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-6 p-px bg-slate-700/50" style={{ clipPath: "polygon(20px 0, 100% 0, 100% calc(100% - 20px), calc(100% - 20px) 100%, 0 100%, 0 20px)" }}>
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-[#12141C] p-6 md:p-8 w-full" style={{ clipPath: "polygon(19px 0, 100% 0, 100% calc(100% - 19px), calc(100% - 19px) 100%, 0 100%, 0 19px)" }}>
            <div className="flex flex-col">
              <h1 className="text-2xl font-black uppercase tracking-widest text-white drop-shadow-md mb-1">Dashboard</h1>
              <p className="text-slate-400 text-xs tracking-widest uppercase font-bold">Halo, <span className="text-[#80FF56]">{member.name}</span></p>
            </div>
        ...
        <div className="space-y-8">
          ...
          {/* TAB 1: BERANDA */}
          <div className={`${activeTab === 'beranda' ? 'block' : 'hidden'} md:block p-px bg-slate-700/50`} style={{ clipPath: "polygon(20px 0, 100% 0, 100% calc(100% - 20px), calc(100% - 20px) 100%, 0 100%, 0 20px)" }}>
            <div className="bg-[#12141C] w-full" style={{ clipPath: "polygon(19px 0, 100% 0, 100% calc(100% - 19px), calc(100% - 19px) 100%, 0 100%, 0 19px)" }}>
              {/* Banner Top */}
              <div className="bg-[#1A1C23] border-b border-slate-800 p-6 text-center">
                <h2 className="text-sm font-bold text-slate-300 uppercase tracking-widest mb-1">Status Absensi (Hari {setting.currentDay})</h2>
              ...
              <div className="p-6 md:p-8">
                {hasAttendedToday ? (
                  ...
                  <div className="text-center p-8 bg-[#7F56FF]/10 border border-[#7F56FF]/20 text-[#7F56FF]" style={{ clipPath: "polygon(12px 0, 100% 0, 100% calc(100% - 12px), calc(100% - 12px) 100%, 0 100%, 0 12px)" }}>
                    ...
                    <p className="hidden md:block text-xs font-bold uppercase tracking-widest text-slate-500">
          ...
          {(!hasAttendedToday && setting.isActive) && (
            <div className={`${activeTab === 'scan' ? 'block' : 'hidden'} md:block p-px bg-slate-700/50`} style={{ clipPath: "polygon(20px 0, 100% 0, 100% calc(100% - 20px), calc(100% - 20px) 100%, 0 100%, 0 20px)" }}>
              <div className="bg-[#12141C] w-full p-6 md:p-8" style={{ clipPath: "polygon(19px 0, 100% 0, 100% calc(100% - 19px), calc(100% - 19px) 100%, 0 100%, 0 19px)" }}>
                <div className="flex flex-col md:flex-row gap-6">
                    {/* Left Box: My QR */}
                    <div className="flex-1 flex flex-col items-center justify-center p-6 bg-[#090A0F] border border-slate-800" style={{ clipPath: "polygon(12px 0, 100% 0, 100% calc(100% - 12px), calc(100% - 12px) 100%, 0 100%, 0 12px)" }}>
                      ...
                      {!showMyQR ? (
                        <div className="flex flex-col items-center text-center">
                          <div className="w-40 h-40 bg-[#12141C] border border-slate-700 flex flex-col items-center justify-center opacity-60 mb-6 relative" style={{ clipPath: "polygon(8px 0, 100% 0, 100% calc(100% - 8px), calc(100% - 8px) 100%, 0 100%, 0 8px)" }}>
                             <QrCode size={40} className="text-slate-500 mb-2" />
                             <span className="text-[10px] text-slate-500 font-bold tracking-widest">TERKUNCI</span>
                          </div>
                          <button 
                            onClick={() => setShowMyQR(true)}
                            className="flex items-center gap-2 bg-[#1A1C23] hover:bg-[#252836] border border-slate-700 text-white px-5 py-3 text-xs font-bold tracking-widest uppercase transition-colors"
                            style={{ clipPath: "polygon(8px 0, 100% 0, 100% calc(100% - 8px), calc(100% - 8px) 100%, 0 100%, 0 8px)" }}
                          >
                        ...
                        <div className="flex flex-col items-center w-full">
                          ...
                          <div className="flex flex-wrap justify-center gap-3 mb-4">
                            <button onClick={handleDownloadQR} className="p-2.5 bg-[#1A1C23] border border-slate-700 text-slate-300 hover:text-white hover:bg-[#252836] transition-colors"><Download size={16} /></button>
                            <button onClick={handlePrintQR} className="p-2.5 bg-[#1A1C23] border border-slate-700 text-slate-300 hover:text-white hover:bg-[#252836] transition-colors"><Printer size={16} /></button>
                    ...
                    <div className="flex-1 flex flex-col items-center justify-center p-6 bg-[#090A0F] border border-slate-800" style={{ clipPath: "polygon(12px 0, 100% 0, 100% calc(100% - 12px), calc(100% - 12px) 100%, 0 100%, 0 12px)" }}>
                      ...
                      {!showScanner ? (
                        <div className="text-center flex flex-col items-center w-full justify-center h-full">
                          <p className="text-xs text-slate-500 font-bold tracking-widest uppercase mb-6 max-w-[200px]">
                            Pindai kode QR dari layar admin
                          </p>
                          <button
                            onClick={() => { setShowScanner(true); setActiveTab('scan'); }}
                            className="flex items-center justify-center gap-2 bg-linear-to-r from-purple-600 to-[#7F56FF] text-white px-6 py-3.5 text-xs font-bold tracking-widest uppercase transition-all hover:scale-[1.02] active:scale-[0.98] shadow-[0_0_15px_rgba(127,86,255,0.3)] w-full max-w-[220px]"
                            style={{ clipPath: "polygon(8px 0, 100% 0, 100% calc(100% - 8px), calc(100% - 8px) 100%, 0 100%, 0 8px)" }}
                          >
          ...
          {/* TAB 3: REKAP */}
          <div className={`${activeTab === 'rekap' ? 'block' : 'hidden'} md:block p-px bg-slate-700/50`} style={{ clipPath: "polygon(20px 0, 100% 0, 100% calc(100% - 20px), calc(100% - 20px) 100%, 0 100%, 0 20px)" }}>
            <div className="bg-[#12141C] w-full p-6 md:p-8" style={{ clipPath: "polygon(19px 0, 100% 0, 100% calc(100% - 19px), calc(100% - 19px) 100%, 0 100%, 0 19px)" }}>
              <h2 className="text-xs font-bold uppercase tracking-widest text-slate-400 mb-6 flex items-center justify-between">
                    ...
                    <div 
                      ...
                      className={`flex flex-col items-center justify-center py-2.5 border transition-colors ${
                        isPresent 
                          ...
                          : 'bg-[#090A0F] border-slate-800 text-slate-600'
                      }`}
      ...
      <div className="fixed bottom-0 left-0 w-full bg-[#090A0F]/95 backdrop-blur-xl border-t border-slate-800/80 flex justify-between items-center px-6 py-3 md:hidden z-50">
        <button onClick={() => handleTabChange('beranda')} className={`flex flex-col items-center gap-1 w-16 relative ${activeTab === 'beranda' ? 'opacity-100' : 'opacity-40 hover:opacity-100 transition-opacity'}`}>
          ...
          <Home className={`w-6 h-6 ${activeTab === 'beranda' ? 'text-[#7F56FF]' : 'text-slate-300'}`} strokeWidth={activeTab === 'beranda' ? 2 : 1.5} />
          <span className={`text-[10px] font-medium ${activeTab === 'beranda' ? 'text-[#7F56FF]' : 'text-slate-300'}`}>Beranda</span>
        </button>
        {(!hasAttendedToday && setting.isActive) && (
          <button onClick={() => handleTabChange('scan')} className={`flex flex-col items-center gap-1 w-16 relative ${activeTab === 'scan' ? 'opacity-100' : 'opacity-40 hover:opacity-100 transition-opacity'}`}>
            ...
            <Scan className={`w-6 h-6 ${activeTab === 'scan' ? 'text-[#80FF56]' : 'text-slate-300'}`} strokeWidth={activeTab === 'scan' ? 2 : 1.5} />
            <span className={`text-[10px] font-medium ${activeTab === 'scan' ? 'text-[#80FF56]' : 'text-slate-300'}`}>Scan</span>
          </button>
        )}
        <button onClick={() => handleTabChange('rekap')} className={`flex flex-col items-center gap-1 w-16 relative ${activeTab === 'rekap' ? 'opacity-100' : 'opacity-40 hover:opacity-100 transition-opacity'}`}>
          ...
          <BarChart2 className={`w-6 h-6 ${activeTab === 'rekap' ? 'text-[#7F56FF]' : 'text-slate-300'}`} strokeWidth={activeTab === 'rekap' ? 2 : 1.5} />
          <span className={`text-[10px] font-medium ${activeTab === 'rekap' ? 'text-[#7F56FF]' : 'text-slate-300'}`}>Rekap</span>
        </button>
        <button onClick={() => handleTabChange('profil')} className={`flex flex-col items-center gap-1 w-16 relative ${activeTab === 'profil' ? 'opacity-100' : 'opacity-40 hover:opacity-100 transition-opacity'}`}>
          ...
          <User className={`w-6 h-6 ${activeTab === 'profil' ? 'text-[#80FF56]' : 'text-slate-300'}`} strokeWidth={activeTab === 'profil' ? 2 : 1.5} />
          <span className={`text-[10px] font-medium ${activeTab === 'profil' ? 'text-[#80FF56]' : 'text-slate-300'}`}>Profil</span>
        </button>
      </div>
