...
import { Camera, X, CheckCircle2, AlertCircle, Eye, EyeOff, Download, Printer, QrCode, ArrowRight, Shield } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-[#0B0D14] text-white font-sans overflow-x-hidden relative selection:bg-[#7F56FF]/30 pb-20">
      ...
      <div className="max-w-4xl mx-auto px-6 py-8 relative z-10">
        ...
        {/* Main Status Panel */}
        <div className="p-px bg-slate-700/50 mb-8" style={{ clipPath: "polygon(20px 0, 100% 0, 100% calc(100% - 20px), calc(100% - 20px) 100%, 0 100%, 0 20px)" }}>
